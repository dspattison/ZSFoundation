...
- (void)testInitialization {
	...
	ZSUInteger *testUInteger2 = [[[ZSUInteger alloc] initWithValue:1] autorelease];
	STAssertTrue(1 == testUInteger2.value, @"2) Initializing with initial value did not work properly!");
	
	ZSUInteger *testUInteger3 = [[[ZSUInteger alloc] initWithValue:2] autorelease];
	STAssertTrue(2 == testUInteger3.value, @"3) Initializing with initial value did not work properly!");
}

- (void)testHashAndEquals {
	ZSUInteger *testUInteger1	= [[[ZSUInteger alloc] initWithValue:1] autorelease];
	ZSUInteger *testUInteger2	= [[[ZSUInteger alloc] initWithValue:5] autorelease];
	ZSUInteger *testUInteger3	= [[[ZSUInteger alloc] initWithValue:5] autorelease];
...
- (void)testCopy {
	ZSUInteger *testUInteger1	= [[[ZSUInteger alloc] initWithValue:-346] autorelease];
...
- (void)testCompare {
	ZSUInteger *testUInteger1	= [[[ZSUInteger alloc] initWithValue:45] autorelease];
	ZSUInteger *testUInteger2	= [[[ZSUInteger alloc] initWithValue:45] autorelease];
	ZSUInteger *testUInteger3	= [[[ZSUInteger alloc] initWithValue:7657] autorelease];
	ZSUInteger *testUInteger4	= [[[ZSUInteger alloc] initWithValue:7657] autorelease];
...
- (void)testNSCoding {
	ZSUInteger *testUInteger1	= [[[ZSUInteger alloc] initWithValue:45645] autorelease];
